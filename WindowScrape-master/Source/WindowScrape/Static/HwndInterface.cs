...
namespace WindowScrape.Static
{
    ...
    internal static class HwndInterface
    {
	    ...
	    public static WindowPlacement GetWindowPlacement(IntPtr hwnd)
	    {
			...
			{
				Position = windowPlacement.rcNormalPosition,
				ShowState = (WindowShowStateEnum)windowPlacement.showCmd
			};
	    }
	    ...
	    public static void SetWindowPlacement(IntPtr hWnd, WindowPlacement value)
	    {
			var windowPlacement = new WINDOWPLACEMENT();

			GetWindowPlacement(hWnd, ref windowPlacement);

		    windowPlacement.showCmd = (int) value.ShowState;
		    windowPlacement.rcNormalPosition = value.Position;
